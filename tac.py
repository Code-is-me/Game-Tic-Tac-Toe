...
def intro():
    ...
    print("\n")
    print("Aturan:Pemain 1 yang diwakili oleh X atau O akan bermain melawan komputer. "
          "Pemain yang berhasil menempatkan tiga tandanya secara horizontal, baris vertikal atau diagonal menang.")
    print("\n")
